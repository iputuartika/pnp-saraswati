...
const { type, variant, size, squared, pill, href, iconOnly, srText, leftIcon, rightIcon } = props
...
<template>
  ...
  >
    ...
    <Icon v-if="leftIcon" :icon="leftIcon" :class="iconSizeClasses" aria-hidden="true" />
    <Icon v-if="icon && iconOnly" :icon="icon" :class="iconSizeClasses" aria-hidden="true" />
    <slot :iconSizeClasses="iconSizeClasses" />
    <Icon v-if="rightIcon" :icon="rightIcon" :class="iconSizeClasses" aria-hidden="true" />
  </router-link>
  <a
    v-else-if="href"
